...
class MainActivity2 : AppCompatActivity(), OnButtonClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        items.add(Item(16, "arlan", "Арлан","Немногословный глава Отдела безопасности космической станции «Герта».\n" +
            ...
            "4", pathDestruction.id, "relics12", typeOfDamageElectro , false))
        items.add(Item(16, "bailu", "Байлу","Жизнерадостная девушка видьядхарского происхождения, прозванная Целительницей-драконом за свой богатый опыт в медицине.\n" +
            ...
            "5", pathAbundance.id, "relics12", typeOfDamageElectro , false))
